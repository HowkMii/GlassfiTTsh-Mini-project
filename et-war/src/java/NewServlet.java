    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          Integer a = Integer.parseInt(id);
            ...
            et.setFname(Nom);
            et.setLname(Prenom);
            et.setNote(Float.parseFloat(note));
            etFacade.create(et);

            out.println("la valeur est  "+id);   out.println("<br>");;;

            out.println("la valeur est  "+Nom); out.println("<br>"); 
            out.println("la valeur est  "+Prenom); out.println("<br>"); 
            out.println("la valeur est  "+note);
